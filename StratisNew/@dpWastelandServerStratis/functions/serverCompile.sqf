...
dp_fnc_activateBase = compileFinal preprocessFileLineNumbers "\@dpWastelandServerAltis\functions\bases\activateBase.sqf";
dp_fnc_deactivateBase = compileFinal preprocessFileLineNumbers "\@dpWastelandServerAltis\functions\bases\deactivateBase.sqf";
