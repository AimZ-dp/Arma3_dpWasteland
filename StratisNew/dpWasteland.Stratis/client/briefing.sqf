...
["=(dp)=","
<br/>2.7.9<br/>
	[Improvement] Changed the way spawn is activated on base flags.<br/>
	[Improvement] Added a radius to the base spawn.<br/>
	[Improvement] Added timer to capturing the base flag.<br/>
	[Improvement] Added a delete function for base objects.<br/>	
	[Fixed] Stopped the objects in the Ghost Hotel falling through floor.<br/>
	[Fixed] Added bigger delay to the heli to stop frozen sound.<br/>
	[Improvement] Increased the vehicle respawn time to 30 mins.<br/>	
<br/>2.7.8<br/>
