...
class RespawnSelectionDialog {
	...
	class controls {
		...
		class TownButton0: w_RscButton
		{
			...
			onButtonClick = "[1,0] call spawnAction";
			text = "";
		...
		class TownButton1: w_RscButton
		{
			...
			onButtonClick = "[1,1] call spawnAction";
			text = "";
		...
		class TownButton2: w_RscButton
		{
			...
			onButtonClick = "[1,2] call spawnAction";
			text = "";
		...
		class TownButton3: w_RscButton
		{
			...
			onButtonClick = "[1,3] call spawnAction";
			text = "";
		...
		class TownButton4: w_RscButton
		{
			...
			onButtonClick = "[1,4] call spawnAction";
			text = "";
