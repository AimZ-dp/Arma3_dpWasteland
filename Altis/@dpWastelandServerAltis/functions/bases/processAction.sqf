...
["_target: %1, %2", name _target, typeof _target] call BIS_fnc_logFormat;
["_caller: %1, %2", name _caller, typeof _caller] call BIS_fnc_logFormat;
["_arguments: %1, %2", _arguments select 0,_arguments select 1] call BIS_fnc_logFormat;
...
switch (_arguments select 0) do 
{
	...
	case "REGISTER": {[_target,_caller] call dp_fnc_registerBase};
	default {};
};
