...
// Create a Gun Store in each Zone
{
	...
	_storeGuy = _gunStoreGroup createunit ["C_man_polo_5_F", _randomPos, [], 1, "NONE"];
	...
	_locIndex = count constructionStoreLocations;
	constructionStoreLocations set [_locIndex, _randomPos];
	
	// Control the guy
	[_storeGuy, _randomPos, "con", _locIndex, _storeHouse] spawn controlStoreGuy;
