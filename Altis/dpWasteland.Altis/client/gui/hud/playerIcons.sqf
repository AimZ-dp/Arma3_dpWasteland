...
addMissionEventHandler ["Draw3D", {
	private ["_playerIcon","_playerPos","_playerName","_playerPosATL","_playerDistance","_iconColour","_iconSize","_target","_uid","_map","_timeOut","_objectDistance","_objectPos","_timeLeft","_lastTimeOut","_scannerStrength"];
