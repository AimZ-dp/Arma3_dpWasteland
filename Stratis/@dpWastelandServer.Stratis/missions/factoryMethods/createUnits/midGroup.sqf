...
_leader addEventHandler ["killed", {_this execVM "\@dpWastelandServer\functions\enemyKilled.sqf"}];
...
_man2 addEventHandler ["killed", {_this execVM "\@dpWastelandServer\functions\enemyKilled.sqf"}];
...
_man3 addEventHandler ["killed", {_this execVM "\@dpWastelandServer\functions\enemyKilled.sqf"}];
...
_man4 addEventHandler ["killed", {_this execVM "\@dpWastelandServer\functions\enemyKilled.sqf"}];
...
_man5 addEventHandler ["killed", {_this execVM "\@dpWastelandServer\functions\enemyKilled.sqf"}];
...
_man6 addEventHandler ["killed", {_this execVM "\@dpWastelandServer\functions\enemyKilled.sqf"}];
...
_man7 addEventHandler ["killed", {_this execVM "\@dpWastelandServer\functions\enemyKilled.sqf"}];
